    ...
    if (sectionRef.current) {
      ...
      loadImages().then(() => {
        ...
        html2canvas(sectionElement, { scale: 4, useCORS: true }).then((canvas) => {
          ...
          downloadLink.download = `${name}-Gretsa National Prog.Cont-2023.png`;
          downloadLink.click();
        });
      });
    }
            ...
            <div className={styles.content}>
              ...
              <ul className={styles.group}>
                <li className={styles.list}>
                  ...
                  <div className={styles.value}>siele@gretsauniversity.ac.ke</div>
                </li>
                <li className={styles.list}>
                ...
                <li className={styles.list}>
                  ...
                  <div className={styles.value}>Gretsa University </div>
                </li>
              </ul>
            </div>
          </div>
