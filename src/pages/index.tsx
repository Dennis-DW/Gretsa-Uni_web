...
import Avatar1 from "@/images/sp_avatar_1.png";
import Avatar2 from "@/images/sp_avatar_2.png";
...
export default function DpGenerator() {
  ...
  return (
    <>
      <SEO
        title=' Gretsa National Programming  contest  2024 DP'
        description='Create and Share your Gretsa Lagos 2024 DP with friends and on your socials'
        keywords='TNPC Gretsa, Programming, contest Gretsa, Contest Gretsa 2024'
      />
      ...
      <main className='dp_gen_page'>
        <header className='dp_gen_page__header'>
          <h2 className='dp_gen_page__header_title'>Gretsa Contest!🥳</h2>
          <p className='dp_gen_page__header_details'>
            Generate and share your unique Gretsa 2024 DP
          </p>

          <figure className='dp_gen_page__header_avatar1'>
            <Image src={Avatar1} alt='Meemoji gretsa' quality={100} />
          </figure>
          <figure className='dp_gen_page__header_avatar2'>
            <Image src={Avatar2} alt='Meemoji gretsa' quality={100} />
          </figure>
          ...
          <section className='dp_gen_page__customize'>
            <div className='dp_gen_page__customize_container'>
              <h4 className='dp_gen_page__customize_title'>
                Customize your Gretsa National Programming Contest DP
              </h4>
              <form className='dp_gen_page__customize_form'>
                ...
                <div className='dp_gen_page__customize_form_group'>
                  <label className='dp_gen_page__customize_form_group_label'>
                    <div>Photo</div>
                    <div>Preferably in a square aspect ratio, add an image of a PNG format.</div>
                  </label>
      ...
      <footer className='c-home__footer'>
        <ul className='c-home__footer__links'>
          <li className='c-home__footer__links__link'>
            <a href='https://gretsauniversity.ac.ke/privacy-statement' target='_blank'>
              Privacy policy
            </a>
          </li>
        </ul>
